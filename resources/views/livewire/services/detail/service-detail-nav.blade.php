        ...
        <div class="flex space-x-2">
            <div>
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                    ...
                    type="button">Semua Devisi <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true"
                ...
                <div id="dropdown"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <button wire:click="$set('searchDivision', '')"
                                class="block w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Semua</button>
                        </li>
                        @foreach ($this->divisions as $division)
                            <li wire:key="{{ $division->id }}">
                                <button wire:click="$set('searchDivision', '{{ $division->id }}')"
                                    class="block w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ $division->name }}</button>
                            </li>
                        @endforeach
                    </ul>
                </div>
                                                ...
                                                <li wire:key="{{ $user->id }}" class="py-3 sm:py-4">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div
                                                            ...
                                                            {{-- <button wire:click="addUser({{ $user->name }})" --}}
